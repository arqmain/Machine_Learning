# ![](http://arqmain.net/RProject_Python_Logos/RLogo_04.png) Machine Learning 
<br>
...
* [ Machine Learning: Portugal Wine. Two Class approach for Red and White classification with Neural Network using R ](https://github.com/arqmain/Machine_Learning/blob/master/R_MLearning/MLearning_Classification_PWine_RedWhite_NNetwork_R_KFold/README.md)

* [ Machine Learning: Portugal Wine. Two Class approach for Quality classification with Neural Network using R ](https://github.com/arqmain/Machine_Learning/blob/master/R_MLearning/MLearning_Classification_PWine_GoodBad_NNetwork_R_KFold/README.md)

* [ MACHINE LEARNING: Portugal Wine. Two Class approach for Red and White classification with Neural Network using R, NEURALNET Library and K fold cross-validation ](https://github.com/arqmain/Machine_Learning/blob/master/R_MLearning/PWine_RedWhite_NNetwork_RNEURALET_KFold/Project9_Portugal_WINE_TwoClass_RedWhite_NNetwork_NEURALNET.ipynb)
